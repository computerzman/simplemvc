            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-user fa-fw"></i> <?= $username_session ?> <i class="fa fa-caret-down"></i>
                    </a>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active_menu">
                            <a href="dashboard.php"><i class="fa fa-dashboard fa-fw"></i> الصفحة الرئيسية</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="people.php?do=manage"><i class="fa fa-users fa-fw"></i> <?=$site_lang['nav_managepeople1']?></a>
                        </li>
                        <li>
                            <a href="benefactors.php"><i class="fi-torsos-all"></i> <?=$site_lang['nav_benefactors1']?></a>
                        </li>
