    ...
    <p class="message" <?= isset($error) ? 'error' : '' ?>><?= $_SESSION['message']?></p>
        <?php
            ...
            <table>
                ...
                <tr>
                    <td>
                       <input required type="text" name="name" id="name" placeholder="Write The Employee Name">
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <input required type="text" name="address" id="address" placeholder="Write The Employee address">
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <input required type="text" name="tax" id="tax">
                    </td>
                </tr>
